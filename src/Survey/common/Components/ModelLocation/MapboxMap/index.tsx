...
const MapboxContainer = ({
  ...
  const style: any = {
    satellite: {
      maxZoom: 19,
      mapStyle: `https://api.maptiler.com/maps/satellite/style.json?key=${config.map.mapboxApiKey}`,
    },

    street: {
      maxZoom: 19,
      mapStyle: `https://api.maptiler.com/maps/openstreetmap/style.json?key=${config.map.mapboxApiKey}`,
    },
  };
